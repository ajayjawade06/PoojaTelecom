...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 pt-24 pb-12 border-t border-white/5 mt-auto relative overflow-hidden">
      {/* Decorative background element */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/5 rounded-full blur-[100px] pointer-events-none translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          {/* Legal/Support */}
          <div>
            <h4 className="text-white font-black text-sm uppercase tracking-[0.2em] mb-8">Support Hub</h4>
            <ul className="space-y-4 font-bold text-sm">
          ...
          {/* Newsletter / Contact */}
          <div>
            <h4 className="text-white font-black text-sm uppercase tracking-[0.2em] mb-8">Stay Connected</h4>
            <div className="bg-white/5 p-6 rounded-3xl border border-white/10">
               <p className="text-xs font-bold text-slate-400 mb-4 leading-relaxed">Join our inner circle for early access and luxury offers.</p>
               <div className="flex gap-2">
                  <input type="email" placeholder="Email" className="w-full bg-slate-800 border-none rounded-xl px-4 py-2 text-xs font-bold focus:ring-1 focus:ring-emerald-500 outline-none" />
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/5 pt-12 text-center md:flex md:justify-between md:text-left items-center">
          <p className="mb-6 md:mb-0 text-xs font-black uppercase tracking-widest text-slate-500">
          ...
          <div className="flex justify-center gap-6 items-center grayscale opacity-30 hover:opacity-100 transition-all duration-700 cursor-pointer">
             <div className="bg-white/10 px-3 py-1 rounded-lg text-[10px] font-black tracking-tighter text-white">VISA</div>
             <div className="bg-white/10 px-3 py-1 rounded-lg text-[10px] font-black tracking-tighter text-white">RAZORPAY</div>
             <div className="bg-white/10 px-3 py-1 rounded-lg text-[10px] font-black tracking-tighter text-white">MASTERCARD</div>
          </div>
        </div>
      </div>
    </footer>
