...
const Paginate = ({ pages, page, isAdmin = false, keyword = '', category = '' }) => {
 ...
 x + 1 === page
 ? 'bg-blue-500 text-white border-blue-500 shadow-lg shadow-blue-500/20 scale-110'
 : 'bg-white text-slate-500 border-slate-100 hover:border-blue-300 hover:text-blue-500'
 }`}
 >
 {x + 1}
 </Link>
