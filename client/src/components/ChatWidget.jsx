...
const ChatWidget = () => {
 ...
 <span className="text-[8px] text-blue-500/80 font-black uppercase tracking-[0.1em]">Ready to Help</span>
 </div>
 </div>
 </div>
 ...
 />
 <button type="submit" className="bg-blue-500 text-white p-2.5 rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:bg-blue-600">
