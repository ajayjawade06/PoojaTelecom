...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen pt-24 lg:pt-32 pb-12 flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-6 animate-fade-in relative overflow-hidden">
      {/* Background Ambience */}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 py-4 pl-12 pr-14 rounded-xl text-xs font-bold outline-none focus:border-emerald-500/30 transition-all dark:text-white tracking-widest"
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  required
                />
                <FaLock className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-emerald-500 transition-colors" size={14} />
                <button
                  type="button"
              ...
              <div className="flex justify-end pr-1 mt-2">
                <Link to="/forgot-password?redirect=/" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-emerald-500 transition-colors">
                  Forgot Password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-10 pt-6 border-t border-slate-100 dark:border-white/5 text-center">
            <p className="text-[12px] font-bold text-slate-400">
              ...
              <Link
                ...
                className="text-emerald-500 font-black hover:underline uppercase tracking-widest ml-2 text-[11px]"
              >
                Sign up here
              </Link>
            </p>
