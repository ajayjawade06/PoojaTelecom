                ...
                <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                   {orders.map(order => (
                      <tr key={order._id} className="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                         ...
                         <td className="p-4 text-center">
                            {order.isCancelled ? (
                               <span className="text-[9px] font-black text-rose-500 bg-rose-500/10 px-2 py-0.5 rounded uppercase border border-rose-500/20">Cancelled</span>
                            ) : order.isDelivered ? (
                          ...
                          <td className="p-4 text-center">
                             <button 
                                ...
                                className={`p-2 rounded-lg transition-all ${order.excludeFromStats ? 'bg-amber-500/10 text-amber-500' : 'bg-slate-100 dark:bg-white/5 text-slate-400 hover:text-emerald-500'}`}
