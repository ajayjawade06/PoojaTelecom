...
const CarouselManager = () => {
 ...
 {/* Create / Edit Form */}
 {isFormOpen && (
 <div className="mb-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl shadow-xl overflow-hidden">
 ...
 className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[12px] font-bold text-slate-900 dark:text-white outline-none focus:border-blue-500/50 transition-colors"
 />
 </div>
 ...
 rows={3}
 className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[12px] font-bold text-slate-900 dark:text-white outline-none focus:border-blue-500/50 transition-colors resize-none"
 />
 </div>
 ...
 className="flex-grow bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[12px] font-bold text-slate-900 dark:text-white outline-none focus:border-blue-500/50 transition-colors"
 />
 <label className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest cursor-pointer transition-all shadow-lg shadow-blue-500/20 shrink-0">
 ...
 className="px-5 py-2.5 bg-blue-500 text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-blue-500/20 flex items-center gap-2"
 >
 <FaSave size={10} />
 ...
 <button
 onClick={openCreateForm}
 className="bg-blue-500 text-white px-6 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-blue-500/20 flex items-center gap-2"
 >
 ...
 {slide.subtitle && (
 <span className="text-[8px] font-black uppercase tracking-widest text-blue-500 bg-blue-500/10 px-1.5 py-0.5 rounded border border-blue-500/20 shrink-0">
 {slide.subtitle}
 </span>
 )}
 </div>
 ...
 {slide.price && (
 <span className="text-[10px] font-black text-blue-500 mt-0.5 inline-block">
 {slide.price}
 </span>
 )}
 </div>
