...
const VerifyEmailPage = () => {
 ...
 <div className="w-full max-w-5xl bg-white/80 dark:bg-slate-900/60 backdrop-blur-2xl rounded-[32px] border border-slate-200/50 dark:border-white/10 shadow-2xl relative z-10 transition-all duration-200 flex flex-col lg:flex-row overflow-hidden">
 
 {/* Left Info Panel */}
 <div className="lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-950 p-12 lg:p-16 flex flex-col justify-center relative overflow-hidden">
 ...
 className="w-10 h-10 sm:w-12 sm:h-14 text-center text-xl font-extrabold border outline-none border-slate-200 dark:border-white/10 rounded-xl bg-slate-50 dark:bg-white/5 focus:bg-white dark:focus:bg-white/10 focus:border-blue-500/50 dark:text-white transition-all shadow-inner"
 />
 ))}
 </div>
 ...
 className="w-full bg-slate-950 dark:bg-white text-white dark:text-slate-950 h-14 rounded-2xl font-black text-[12px] uppercase tracking-widest shadow-xl transition-all flex items-center justify-center gap-3 relative overflow-hidden group/btn disabled:opacity-50 disabled:cursor-not-allowed"
 >
