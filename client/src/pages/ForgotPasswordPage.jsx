...
import { useForgotPasswordMutation } from '../redux/slices/usersApiSlice';
import { FaEnvelope, FaArrowRight, FaLockOpen } from 'react-icons/fa';
      ...
      <div className="w-full max-w-5xl bg-white/80 dark:bg-slate-900/60 backdrop-blur-2xl rounded-[32px] border border-slate-200/50 dark:border-white/10 shadow-2xl relative z-10 transition-all duration-500 hover:shadow-emerald-500/5 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 p-12 lg:p-16 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 text-white">
            <h2 className="text-3xl lg:text-5xl font-black mb-6 tracking-tighter leading-tight">Account Recovery.</h2>
            <p className="text-slate-300 text-sm lg:text-base leading-relaxed mb-8 max-w-sm">We'll help you securely reset your password. Enter the email address associated with your account to receive a one-time verification code.</p>
            <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.2em] text-emerald-400">
               <FaLockOpen size={12}/> Secure Protocol Active
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center relative">
          ...
          <div className="mb-10">
             <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter mb-2">Recover Account</h1>
             <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Enter your email below</p>
          </div>
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            ...
            >
              ...
              {isLoading ? (
                ...
                <span className="relative z-10 flex items-center gap-3">Send OTP Code <FaArrowRight size={10} /></span>
              )}
            </button>
          </form>

          <div className="mt-10 pt-6 border-t border-slate-100 dark:border-white/5 text-center">
            <Link to="/login" className="text-[11px] uppercase tracking-widest font-black text-slate-400 hover:text-emerald-500 transition-colors">
              Back to Login
            </Link>
          </div>
        </div>
